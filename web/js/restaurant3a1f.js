 ...
 simpleCart({
    ...
    checkout: { 
        type: "SendForm" , 
        //url: base_url+'cart/pay',
        url: base_url+'cart/orderinfo',

        // http method for form, "POST" or "GET", default is "POST"
        method: "POST" , 

        // url to return to on successful checkout, default is null
        success: base_url + "cart/orderinfo" ,

        // url to return to on cancelled checkout, default is null
        cancel: base_url+"cart/orderinfo" ,
...
/*	beforeCheckout		: null, */
        beforeCheckout: function( data ){
                  data.specialmsg   = $("#msg").html();
                  data.deliverytime = $('#deliveryAt').html();
